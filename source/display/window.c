...
static void initialise_the_sounds(gamestate_t *gamestate)
{
    ...
    gamestate->sound_buffer[0] = sfSoundBuffer_createFromFile("ressources/sounds/LEVER.ogg");
    gamestate->sound_buffer[1] = sfSoundBuffer_createFromFile("ressources/sounds/OPEN_DOOR.ogg");
    gamestate->sound_buffer[2] = sfSoundBuffer_createFromFile("ressources/sounds/SHUT_DOOR.ogg");
    gamestate->sound_buffer[3] = sfSoundBuffer_createFromFile("ressources/sounds/SLASH.ogg");
    gamestate->sound_buffer[4] = sfSoundBuffer_createFromFile("ressources/sounds/SPIKE_TRAP.ogg");
    for (int i = 0; i < 5; i++) {
...
gamestate_t *initalise_gamestate(void)
{
    ...
    gamestate->music = sfMusic_createFromFile("ressources/music/GAME_MUSIC.ogg");
